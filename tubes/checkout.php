...
<body>
	...
	<div class="checkout">
		<div class="container">
			...
			<hr>
			<br><center>
			<h2>Total harga yang tertera di atas sudah termasuk ongkos kirim sebesar Rp10.000, Bila telah melakukan pembayaran, harap konfirmasikan pembayaran Anda.</h2>
			<br>
